...
from masy.receipe.models import CookBook, CookBookReceipe, Country, Picture, Tag
...
def run(*args):
    ...
    MeatReceipe.objects.get(pk=1).update(picture= Picture.objects.get(pk=1)) # asocjacja kwalifikowana
